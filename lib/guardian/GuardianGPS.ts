export type GuardianLocation = {
  latitude: number;
  longitude: number;
  accuracy?: number;
};

export function getCurrentGPS(): Promise<GuardianLocation> {
...
export function watchGPS(
  onUpdate: (location: GuardianLocation) => void,
...
export function stopGPSWatch(watchId: number | null) {
